<?php
	...
	function wprss_kf_add_settings() {
		...
		add_settings_section(   
			...
			__( 'Keyword Filtering Settings', 'wprss' ),    // Title to be displayed on the administration page  
		...
		add_settings_section(   
			...
			__( 'Tag Filtering Settings', 'wprss' ),    	// Title to be displayed on the administration page  
		...
		add_settings_field(
			...
			__( 'Contains <b>all</b> these words/phrases', 'wprss' ),
		...
		add_settings_field(
			...
			__( 'Contains <b>any</b> these words/phrases', 'wprss' ),
		...
		add_settings_field(
			...
			__( 'Contains <b>none</b> these words/phrases', 'wprss' ),
		...
		add_settings_field(
			...
			__( 'Contains <b>any</b> these tags', 'wprss' ),
		...
		add_settings_field(
			...
			__( 'Contains <b>none</b> these tags', 'wprss' ),
	...
	function wprss_kf_setting_license_callback( $args ) {
		...
		echo "<label class='description' for='wprss-kf-license-key'>" . __( 'Enter your license key', 'wprss' ) . '</label>';                   
	}    
	...
	function wprss_kf_setting_license_activation_callback( $args ) {
	   ...
	   // if( '' === $kf_license_key ) { ?>
			...
			<?php if( $kf_license_status != FALSE && $kf_license_status == 'valid' ) { ?>
					...
					<input type="submit" class="button-secondary" name="wprss_kf_license_deactivate" value="<?php _e( 'Deactivate License', 'wprss' ); ?>"/>
			<?php } else {
					wp_nonce_field( 'wprss_kf_license_nonce', 'wprss_kf_license_nonce' ); ?>
					<input type="submit" class="button-secondary" name="wprss_kf_license_activate" value="<?php _e( 'Activate License', 'wprss' ); ?>"/>
			<?php //} ?>
	...
	function wprss_settings_kf_callback() {
		echo '<p>' . __( 'Global keyword filtering settings', 'wprss' ) . '</p>';
	}
	...
	function wprss_settings_kf_tags_callback() {
		echo '<p>' . __( 'Global tag filtering settings', 'wprss' ) . '</p>';
	}
