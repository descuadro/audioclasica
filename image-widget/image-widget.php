...
class Tribe_Image_Widget extends WP_Widget {
	...
	private function get_image_html( $instance, $include_link = true ) {
		...
		if ( !empty( $instance['imageurl'] ) ) {
			...
			$output .= rtrim('<source srcset="');
			$output .= $instance['imageurl'];
...
private function get_image_html2( $instance, $include_link = true ) {
...
private function get_image_html3( $instance, $include_link = true ) {
