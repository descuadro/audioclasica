            ...
            <?php if ( $last_update !== '' ): ?>
              <p class="last-update-container">
                ...
                <?php if ( $last_update_items !== '' ): ?>
                    <span class="last-update-imported-container"><br/>Última actualización importó: <code class="last-update-imported"><?php echo $last_update_items; ?></code> items</span>
                <?php endif; ?>
              </p>
            <?php endif;
