<?php    
    ...
    function wprss_register_post_types() {        
        ...
        $labels = apply_filters( 
            ...
            array(
                'name'                  => __( 'Fuente RSS', 'wprss' ),
                'singular_name'         => __( 'Fuente RSS', 'wprss' ),
                'add_new'               => __( 'Agregar nueva fuente', 'wprss' ),
                'all_items'             => __( 'Fuentes RSS', 'wprss' ),
                'add_new_item'          => __( 'Agregar fuente', 'wprss' ),
                'edit_item'             => __( 'Editar fuente RSS', 'wprss' ),
                'new_item'              => __( 'Nueva fuente RSS', 'wprss' ),
                'view_item'             => __( 'Ver fuente RSS', 'wprss' ),
                'search_items'          => __( 'Buscar fuente RSS', 'wprss' ),
                'not_found'             => __( 'Nada encontrado', 'wprss' ),
                'not_found_in_trash'    => __( 'Nada encontrado', 'wprss' ),
